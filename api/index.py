...
# Função para buscar valores da BD
def get_light_values():
    try:
        ...
        return results  # lista de tuplos (valor, timestamp)
    except Exception as e:
...
# Rota principal para mostrar tabela de valores
@app.route('/')
def mostrar_luz():
    valores = get_light_values()
    return render_template("luz.html", valores=valores)

# >>> NOVO: Rota para desligar LED
